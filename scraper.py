#!/usr/bin/env python3
"""
ScrapingBee Alternative - Free open-source ScrapingBee alternative - headless browser scraper
Open source scraper for scrapingbee alternative, scrapingbee free alternative, web scraping api
...
class ScrapingbeeAlternativeScraper:
    """Scraper for ScrapingBee Alternative."""
...
def main():
    parser = argparse.ArgumentParser(description="ScrapingBee Alternative - Free open-source ScrapingBee alternative - headless browser scraper")
    ...
    scraper = ScrapingbeeAlternativeScraper(proxy=args.proxy)
